...
---
#### **12. Select your desired options such as ***WSA Release Channel***(Must choose Insider Private for getting latest Insider build) ***Magisk Version***, ***WSA Archetecture*** , ***GApps Varient*** and ***Compression Format*** then click **Run workflow****
